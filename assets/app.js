...
const buildingRows = [
  ...
  ["9幢", "会所：五感书房&业主派会客", "礼序会客共享厅", "台球、德扑、桌游", "会客休憩、邻里交流", "台球桌、德扑桌、桌游收纳、重点照明、隔音与通风"],
  ...
  ["15幢", "优雅生活：瑜伽会馆&开放会客", "云境美塑会馆", "封闭普拉提私教、独立休憩补给", "扩容瑜伽舞房、原普拉提室保留为冥想/拉伸/私教房", "全封闭优先，木地板+高品质软地胶、镜墙、普拉提床、新风除湿"],
  ["16幢", "自然生活：科普讲堂&社区展廊", "森氧自然疗愈厅", "自然科普、园艺花艺、社区讲堂", "学习/理疗/冥想放松、社区展廊", "绿植、可移动桌椅、柔光、除湿、展陈系统、理疗放松软装"],
  ["17幢", "学习娱乐：预约自习室&棋牌套房", "邻里弈乐会馆", "大棋牌麻将套房", "小棋牌室、茶歇等候、公共卫生间", "隔音、排风、耐污墙面、舒适座椅、储物"],
  ["18幢", "学习娱乐：预约自习室&棋牌套房", "轻学禅室", "预约自习、安静阅读、轻办公", "静思冥想、自习延展、舒缓放松", "隔音、柔光、木质感材料、窗帘遮挡、安静座椅"],
  ["19幢", "高雅生活：绅士会馆&商务会客", "菁英商务会客厅", "绅士会所、商务社交", "商务会客、洽谈、轻宴请", "高装标体现逼格，皮质/木饰面/金属细节"]
];
...
const buildingDetails = [
  ...
  ["9幢", "礼序会客共享厅", "会所：五感书房&业主派会客", "台球、德扑、桌游", "会客休憩、邻里交流", "台球桌、德扑桌、桌游收纳、重点照明、隔音和通风，强化会客与轻娱乐属性。"],
  ...
  ["15幢", "云境美塑会馆", "优雅生活：瑜伽会馆&开放会客", "封闭普拉提私教、独立休憩补给", "扩容瑜伽舞房、原普拉提室保留为冥想/拉伸/私教房", "全封闭优先；木地板+高品质软地胶、镜墙、普拉提床、新风除湿、储物、更衣与预约机制。"],
  ["16幢", "森氧自然疗愈厅", "自然生活：科普讲堂&社区展廊", "自然科普、园艺花艺、社区讲堂", "学习/理疗/冥想放松、社区展廊", "绿植、可移动桌椅、柔光、除湿、展陈系统、理疗放松软装和软垫收纳，避免固定展板低频闲置。"],
  ["17幢", "邻里弈乐会馆", "学习娱乐：预约自习室&棋牌套房", "大棋牌麻将套房", "小棋牌室、茶歇等候、公共卫生间", "隔音、排风、耐污墙面、舒适座椅、自动麻将桌和卫生间便利性。"],
  ["18幢", "轻学禅室", "学习娱乐：预约自习室&棋牌套房", "预约自习、安静阅读、轻办公", "静思冥想、自习延展、舒缓放松", "隔音、柔光、木质感材料、窗帘遮挡和安静座椅，承担学习冥想补充，避免与17幢棋牌重复。"],
  ["19幢", "菁英商务会客厅", "高雅生活：绅士会馆&商务会客", "绅士会所、商务社交", "商务会客、洽谈、轻宴请", "高装标体现逼格，皮质、木饰面、金属细节和会议屏。"]
];
